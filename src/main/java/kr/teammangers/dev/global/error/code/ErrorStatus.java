...
public enum ErrorStatus implements ErrorBaseCode {
    ...
    TEAM_MEMBER_TAG_NOT_FOUND(NOT_FOUND, "TEAM_MEMBER_TAG404", entityNotFoundMessage("팀멤버-태그 매핑 테이블")),
    ...
    DATA_FILE_NOT_FOUND(NOT_FOUND, "DATA_FILE404", entityNotFoundMessage("자료-S3 매핑 테이블")),

    DATA_NOT_FOUND(HttpStatus.NOT_FOUND, "DATA4001", "해당 자료를 찾을 수 없습니다."),
    FEEDBACK_NOT_FOUND(HttpStatus.NOT_FOUND, "FEEDBACK4001", "해당 피드백을 찾을 수 없습니다.")
    ;
