...
public class ExceptionAdvice extends ResponseEntityExceptionHandler {
    ...
    private ResponseEntity<Object> handleExceptionInternal(final Exception e, final ErrorReasonDto reason,
        ...
        ApiRes<Object> body = ApiRes.onFailure(reason.code(), reason.message(), null);
    ...
    private ResponseEntity<Object> handleExceptionInternalFalse(final Exception e, final HttpStatus status,
        ...
        ApiRes<Object> body = ApiRes.onFailure(ErrorStatus._INTERNAL_SERVER_ERROR.getCode(), ErrorStatus._INTERNAL_SERVER_ERROR.getMessage(), errorPoint);
        return super.handleExceptionInternal(
                e,
                body,
                HttpHeaders.EMPTY,
    ...
    private ResponseEntity<Object> handleExceptionInternalArgs(final Exception e, final ErrorStatus errorCommonStatus,
        ...
        ApiRes<Object> body = ApiRes.onFailure(errorCommonStatus.getCode(), errorCommonStatus.getMessage(), errorArgs);
        return super.handleExceptionInternal(
                e,
                body,
                HttpHeaders.EMPTY,
    ...
    private ResponseEntity<Object> handleExceptionInternalConstraint(final Exception e, final ErrorStatus errorCommonStatus,
        ...
        ApiRes<Object> body = ApiRes.onFailure(errorCommonStatus.getCode(), errorCommonStatus.getMessage(), null);
        return super.handleExceptionInternal(
                e,
                body,
                HttpHeaders.EMPTY,
